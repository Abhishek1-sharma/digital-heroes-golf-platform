...
const charitiesToUpdate = [
  {
    name: "Play Golf",
    long_description: `Play Golf is one of the largest British charities and provides specialist health care, information and financial support to people affected by cancer. It also looks at the social, emotional and practical impact cancer can have, and campaigns for better cancer care.\n\nFrom the moment you're diagnosed, for as long as you need us, you can lean on Macmillan. We help you find your best way through from the moment of diagnosis, so you're able to live life as fully as you can.`,
    image_url: "/images/charity-fallback.svg",
    featured: true,
    upcoming_events: [
      {
        title: "The World's Biggest Coffee Morning",
        date: "Sept 27, 2026",
        location: "Nationwide / UK",
      },
      {
        title: "London Marathon Charity Wave",
        date: "April 20, 2026",
        location: "London, UK",
      },
    ],
