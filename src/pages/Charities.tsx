      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-24">
          ...
          <p className="text-on-surface-variant text-xl max-w-2xl mx-auto leading-relaxed font-sans">
            Every round you play contributes to a global force for good. Explore
            the charities supported by the Play Golf community.
          </p>
        </div>
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        {user ? (
                          ...
                          <Link
                            to="/login"
                            className="flex-1 py-4 rounded-full bg-gradient-to-br from-primary to-primary-container text-background text-[10px] font-bold uppercase tracking-widest flex items-center justify-center gap-2 hover:scale-105 transition-all active:scale-95"
                          >
                            Login to Select
                          </Link>
                        )}
