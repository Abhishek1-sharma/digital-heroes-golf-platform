...
import { MIN_CHARITY_PERCENTAGE, PLANS } from "../lib/platform";
  ...
  const onSubmit = async () => {
    ...
    try {
      const { error: onboardingError } = await supabase.rpc(
        "complete_onboarding",
        {
          p_charity_id: selectedCharity.id,
      ...
      <div className="max-w-4xl mx-auto w-full px-6 py-12 relative z-10 flex-grow flex flex-col">
        ...
        <div className="flex items-center gap-4 mb-16">
          {[1, 2, 3].map((s) => (
            <div
              key={s}
              className="flex-1 h-1.5 rounded-full bg-white/5 relative overflow-hidden"
            >
              <motion.div
                initial={false}
              ...
              >
                <div>
                  ...
                  <p className="text-on-surface-variant font-sans text-lg max-w-xl">
                    Every member joins the matrix with a primary purpose. Choose
                    a partner that aligns with your values.
                  </p>
                </div>
                ...
                <div className="max-w-sm">
                  ...
                  <input
                    ...
                    className="w-full bg-surface-container-low border border-white/5 rounded-xl py-4 px-5 text-sm outline-none focus:border-primary"
                  />
                </div>
                ...
                {loadingCharities ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-16 gap-4 text-center">
                    ...
                    <p className="font-display font-bold uppercase tracking-tight text-xl">
                      No matches
                    </p>
              ...
              >
                <div>
                  <h1 className="text-4xl md:text-5xl font-display font-black uppercase tracking-tighter mb-4 leading-none text-center">
                    Define your{" "}
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary via-primary to-secondary italic">
                      Impact.
                    </span>
                  </h1>
                  <p className="text-on-surface-variant font-sans text-lg max-w-xl mx-auto text-center">
                    Set the baseline contribution from your subscription. 100%
                    of these funds go directly to{" "}
                ...
                <div className="glass-card p-12 text-center max-w-xl mx-auto">
                  <div className="mb-12">
                    <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-on-surface-variant block mb-4">
              ...
              >
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        plan === p.type
                          ? "border-primary bg-primary/5 shadow-[0_0_30px_rgba(78,222,163,0.1)]"
                          : "hover:border-primary/20",
                      )}
                    >
                      {plan === p.type && (
                      ...
                      <p className="text-[9px] text-on-surface-variant font-sans uppercase tracking-widest mb-6 opacity-60">
                        {p.desc}
                      </p>
                      ...
                      <div className="space-y-3 mb-8 flex-grow">
                        {p.features.map((f, i) => (
                          <div
                            key={i}
                            className="flex items-center gap-2 text-[9px] font-bold uppercase tracking-widest text-on-surface-variant/80"
                          >
                ...
                <div className="bg-white/5 border border-white/10 rounded-3xl p-10 max-w-3xl mx-auto">
                  <div className="flex items-center gap-6 mb-8">
                    ...
                    <div>
                      <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-on-surface-variant block mb-1 underline">
                        Selected Partner
                      </span>
        ...
        <div className="mt-16 pt-10 border-t border-white/5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-on-surface-variant hidden sm:block">
              Step {step} of 3
            </span>
            {step < 3 ? (
              <button
