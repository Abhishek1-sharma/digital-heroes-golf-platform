...
const AdminUsers: React.FC = () => {
  ...
  const [selectedUserForScores, setSelectedUserForScores] = useState<
    any | null
  >(null);
  const [selectedUserForSubscription, setSelectedUserForSubscription] =
        ...
        <div className="max-w-3xl">
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.3em] text-primary">
              Protocol 02: User Identity Matrix
            </span>
          </div>
          ...
          <p className="text-xl text-on-surface-variant font-sans max-w-2xl">
            Audit protocol entry permissions, verify player identities, and
            manage strategic administrative roles within the matrix.
          </p>
        </div>
                        ...
                        <div className="relative">
                          ...
                          <div
                            className={cn(
                              ...
                              u.subscription?.[0]?.status === "active"
                                ? "bg-primary"
                                : "bg-on-surface-variant opacity-30",
                            )}
                          />
                        </div>
                        <div>
                      ...
                      <div className="flex items-center gap-6">
                        <div>
                          ...
                          <p className="font-display font-bold text-on-surface">
                            {formatCurrency(u.total_impact || 0)}
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="font-display font-bold text-primary">
                            {formatCurrency(u.lifetime_winnings || 0)}
                          </p>
                        </div>
                      </div>
                    </td>
    ...
    try {
      if (planType === "cancel") {
        ...
        if (!profData || profData.length === 0) {
          throw new Error(
            "Administrative override denied. Please check RLS policies.",
          );
        }
      } else {
        // Upgrade
      ...
      setMessage({
        type: "success",
        text: `Protocol updated: ${planType === "cancel" ? "Deactivated" : "Upgraded to " + planType}`,
      });
      setTimeout(() => {
        onSuccess();
        onClose();
      ...
      >
        ...
        <div className="mb-10">
          ...
          <p className="text-on-surface-variant text-sm font-sans">
            Administrative override for user:{" "}
            <span className="text-on-surface font-bold">{user.full_name}</span>
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="p-6 bg-white/5 rounded-2xl border border-white/5 flex items-center justify-between">
            <div>
              <p className="text-[8px] font-bold uppercase tracking-widest text-on-surface-variant mb-1">
                Current Standing
              </p>
