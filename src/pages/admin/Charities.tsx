...
const AdminCharities: React.FC = () => {
  ...
  const [editingCharity, setEditingCharity] = useState<CharityEntry | null>(
    null,
  );
  ...
  const handleDelete = async (id: string, name: string) => {
    if (
      !window.confirm(
        `Are you absolutely sure you want to delete ${name}? This action is irreversible and may affect existing subscriptions.`,
      )
    ) {
      return;
    }
    ...
    try {
      ...
      alert(
        "Failed to delete charity. It may be referenced by existing subscriptions or donations.",
      );
    }
  };
        ...
        <div className="max-w-3xl">
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.3em] text-primary">
              Protocol 03: Charity Matrix Control
            </span>
          </div>
          ...
          <p className="text-xl text-on-surface-variant font-sans max-w-2xl">
            Onboard new impact entities, manage global featuring priority, and
            audit total contributions across the distributed network.
          </p>
        </div>
                ...
                <tr>
                  <td colSpan={5} className="px-10 py-32 text-center">
                    <EmptyState
                      ...
                      action={{
                        label: "Onboard Strategic Partner",
                        onClick: openCreateModal,
                      }}
                  ...
                  >
                    ...
                    <td className="px-10 py-8 text-right">
                      <div className="flex flex-col items-end gap-1">
                        <p className="font-display font-bold text-2xl text-primary tracking-tighter">
                    ...
                    <label className="flex items-center gap-4 cursor-pointer group">
                      <div
                        ...
                        className={cn(
                          ...
                          formData.featured ? "bg-secondary" : "bg-white/10",
                        )}
                      >
                        <div
                          className={cn(
                            "w-4 h-4 bg-white rounded-full transition-all",
                            formData.featured ? "ml-6" : "ml-0",
                          )}
                        />
                      </div>
