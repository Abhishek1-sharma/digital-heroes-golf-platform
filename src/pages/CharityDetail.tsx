    ...
    return (
      <div className="min-h-screen pt-40 px-6 bg-background flex flex-col items-center">
        <div className="glass-card p-20 text-center max-w-2xl border-dashed">
          ...
          <h1 className="text-4xl font-display font-black uppercase mb-4 tracking-tighter">
            Node Not Found
          </h1>
          <p className="text-on-surface-variant mb-12">
            The charity profile you are looking for has been moved or does not
            exist in the matrix.
          </p>
          <Link
            to="/charities"
            className="inline-flex items-center gap-4 bg-primary text-background px-10 py-5 rounded-full font-bold uppercase tracking-widest hover:scale-105 transition-all"
          >
              ...
              >
                ...
                <div className="flex flex-col items-start md:items-end gap-6">
                  <div className="text-left md:text-right">
                    <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-on-surface-variant mb-2">
                      Total Generated Impact
                    </p>
                  ...
                  <div className="flex flex-col md:flex-row gap-4">
                    ...
                    >
                      <Heart className="w-4 h-4 text-primary" /> One-time
                      Donation
                    </button>
                    <button
                    ...
                    >
                      {selecting ? (
                        ...
                        <>
                          <CheckCircle2 className="w-5 h-5" /> Currently
                          Supporting
                        </>
                      ) : (
                        <>
                          <Zap className="w-5 h-5" />{" "}
                          {user ? "Commit Support" : "Join to Support"}
                        </>
                      )}
                    </button>
                  </div>
                    ...
                    {charity.long_description ? (
                      <div
                        dangerouslySetInnerHTML={{
                          __html: charity.long_description.replace(
                            /\n/g,
                            "<br />",
                          ),
                        }}
                      ...
                      <p>
                        This organization's complete operational matrix is
                        currently being synchronized. Supporting {charity.name}{" "}
                        directly impacts critical local initiatives within the{" "}
                        {charity.category} sector.
                      </p>
                    )}
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-3">
                      {[
                        ...
                        <li
                          key={i}
                          className="flex items-center gap-3 text-sm text-on-surface-variant font-sans"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {events.map((event, idx) => (
                        ...
                        >
                          ...
                          <h4 className="text-xl font-display font-bold uppercase mb-2 tracking-tight">
                            {event.title}
                          </h4>
            ...
            <div className="space-y-8">
              <div className="glass-card p-10 bg-surface-container-high/30">
                ...
                <p className="text-xs text-on-surface-variant leading-relaxed mb-10 font-sans">
                  By supporting {charity.name}, 100% of your allocated monthly
                  pledge is transferred via the Sovereign Distributed Ledger to
              ...
              >
                ...
                <p className="text-xl font-display font-bold uppercase mb-8 leading-tight">
                  Join the Elite Circle to Start Supporting Causes.
                </p>
