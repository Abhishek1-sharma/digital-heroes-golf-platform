  ...
  const handleActivate = async () => {
    ...
    const priceId =
      selectedPlan.type === "monthly"
        ? (import.meta as any).env.VITE_STRIPE_MONTHLY_PRICE_ID
        : (import.meta as any).env.VITE_STRIPE_YEARLY_PRICE_ID;
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-20">
        <div>
          ...
          <p className="mt-8 text-lg text-on-surface-variant max-w-2xl leading-relaxed">
            Manage your standing in the elite circle. Your membership fuels
            global change while providing absolute precision in your performance
            rewards.
          </p>
        </div>
          ...
          {isActive ? (
                ...
                {subscription?.plan_type !== "yearly" && (
                  <div className="mt-12 pt-12 border-t border-white/5">
                    <h3 className="text-xl font-display font-black uppercase tracking-tight mb-8">
                      Available Level-Up Nodes
                    </h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {subscription?.plan_type === "free" && (
                        <div
                          onClick={() =>
                            setSelectedPlan({ type: "monthly", price: 25 })
                          }
                        ...
                        >
                          <div>
                            <span className="text-[10px] font-black uppercase text-primary block mb-1">
                              Elite Node
                            </span>
                            <span className="text-2xl font-display font-black tracking-tight italic">
                              £25{" "}
                              <span className="text-xs font-sans not-italic text-on-surface-variant">
                                / MO
                              </span>
                            </span>
                          </div>
                      ...
                      >
                        <div>
                          <span className="text-[10px] font-black uppercase text-secondary block mb-1">
                            Sovereign Node
                          </span>
                          <span className="text-2xl font-display font-black tracking-tight italic">
                            {PLANS.yearly.label}{" "}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              {[
                ...
                <div
                  key={plan.type}
                  className="glass-card p-1 rounded-[2.5rem] group cursor-pointer hover:scale-[1.02] transition-all duration-500 shadow-2xl shadow-black/20"
                  onClick={() =>
                    setSelectedPlan({ type: plan.type, price: plan.price })
                  }
                >
                  <div className="bg-surface-container-low/50 p-10 h-full flex flex-col">
                    <div
                      className={cn(
                        ...
                        plan.color === "primary"
                          ...
                          : "bg-secondary/20 text-secondary shadow-secondary/20",
                      )}
                    >
                    ...
                    <p className="text-on-surface-variant text-sm mb-10 leading-relaxed font-sans">
                      {plan.desc}
                    </p>
            ...
            {[
              {
                ...
                desc: "Real-time verified score ingestion from club global nodes.",
              },
              {
                icon: ShieldCheck,
                title: "Verified Impact",
                desc: "1-for-1 Charity impact matching protocol on every performance.",
              },
              {
                icon: Award,
                title: "Elite Rewards",
                desc: "Access to monthly prize tiers with jackpot rollover.",
              },
              {
                icon: CreditCard,
                title: "Secure Billing",
                desc: "Premium end-to-end encrypted subscription management.",
              },
            ].map((benefit, idx) => (
              <div
                key={idx}
                className="flex gap-6 p-6 rounded-3xl bg-white/20 border border-white/5 group hover:bg-white/5 transition-colors"
              >
                ...
                <div>
                  <h4 className="text-sm font-bold uppercase tracking-wider text-on-surface mb-2">
                    {benefit.title}
                  </h4>
        ...
        <div className="space-y-10">
          <div className="glass-card p-1 rounded-[2.5rem]">
            <div className="bg-surface-container-low p-10 flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-display font-black uppercase mb-3 tracking-tight">
                Active Partner
              </h3>
              ...
              <div className="grid grid-cols-2 gap-8 w-full">
                <div className="text-left">
                  <span className="text-[8px] font-bold uppercase tracking-widest text-on-surface-variant block mb-1">
                    Impact
                  </span>
        ...
        {showCancelConfirm && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-6">
            ...
            >
              ...
              <h3 className="text-3xl font-display font-black uppercase mb-4 tracking-tight">
                System Deactivation
              </h3>
              <p className="text-sm text-on-surface-variant font-sans leading-relaxed mb-10">
                Terminating your Elite protocol connection will immediately lock
                your access to draw participation and winnings accrual. Your
                historical impact progress will be archived.
              </p>
