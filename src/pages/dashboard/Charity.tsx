...
const CharitySelection: React.FC = () => {
  ...
  const handleSelectCharity = async (charityId: string) => {
    ...
    try {
      ...
      setMessage({
        type: "success",
        text: "Impact partner updated successfully.",
      });
    } catch (error: any) {
      console.error("Error selecting charity:", error);
      setMessage({
        type: "error",
        text: error.message || "Failed to update partner.",
      });
    } finally {
      setSelectingId(null);
    }
  ...
  const handleSave = async () => {
    if (!isPremium) {
      setMessage({
        type: "error",
        text: "Premium membership required to set persistent impact preferences.",
      });
      return;
    }
    setSaving(true);
    ...
    try {
      ...
      setMessage({
        type: "success",
        text: "Impact preferences updated successfully.",
      });
    } catch (err: any) {
          ...
          <div className="max-w-2xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-primary">
                Protocol 05: Impact Distribution Matrix
              </span>
            </div>
            ...
            <p className="text-xl text-on-surface-variant font-sans">
              Explore the global partner network and define your contribution
              weight within the Sovereign Ledger.
            </p>
          </div>
        ...
        {!isPremium && (
          <div className="mb-12 p-8 bg-secondary/10 border border-secondary/30 rounded-[2.5rem] flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex items-center gap-6">
              ...
              <div>
                <h4 className="text-2xl font-display font-black uppercase tracking-tight mb-1">
                  Spectator Protocol Active
                </h4>
                <p className="text-on-surface-variant max-w-xl">
                  Identity verified, but a premium subscription is required to
                  persist impact preferences and initialize draw participation.
                </p>
              </div>
            </div>
            <Link
              to="/dashboard/subscription"
              className="px-10 py-5 bg-secondary text-background rounded-full font-bold uppercase tracking-widest text-[10px] hover:scale-105 transition-all shadow-xl shadow-secondary/20 whitespace-nowrap text-center"
            >
              Upgrade Access
            </Link>
          </div>
                    ...
                    >
                      <div className="p-8">
                        <div className="flex items-center gap-6">
                          ...
                          <div className="flex-grow">
                            <span className="text-[9px] font-bold uppercase tracking-widest text-primary mb-1 block">
                              {charity.category}
                            </span>
                            <Link
                              to={`/charities/${charity.slug}`}
                              ...
                              className="block"
                            >
                              <h3 className="text-xl font-display font-bold uppercase tracking-tight leading-tight mb-2 hover:text-primary transition-colors">
                                {charity.name}
                              </h3>
                            </Link>
                            <div className="flex items-center justify-between">
                              <span className="text-[10px] text-on-surface-variant font-sans line-clamp-1">
                                {charity.website_url.replace(
                                  /^https?:\/\//,
                                  "",
                                )}
                              </span>
                ...
                <div className="sticky top-12 space-y-8">
                  <div className="glass-card p-10 bg-surface-container-high/30">
                    <h3 className="text-2xl font-display font-bold uppercase tracking-tight flex items-center gap-4 mb-10">
                      <Target className="w-6 h-6 text-primary" /> Active
                      Allocation
                    </h3>
                    ...
                    {selectedCharity ? (
                      <div className="space-y-10">
                        <div className="p-8 bg-background/50 rounded-[2rem] border border-white/5">
                          <div className="flex items-center gap-6">
                            ...
                            <div>
                              <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-on-surface-variant mb-1">
                                Active Beneficiary
                              </p>
                        ...
                        <div className="space-y-6">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="font-display font-bold text-4xl text-primary">
                              {contributionPct}
                              <span className="text-lg font-sans ml-1 text-on-surface-variant">
                                %
                              </span>
                            </span>
                          </div>
                          <input
                            ...
                            onChange={(e) =>
                              setContributionPct(parseInt(e.target.value))
                            }
                            disabled={!isPremium}
                          ...
                          <div className="mt-10 p-6 bg-primary/5 border border-primary/20 rounded-2xl flex items-start gap-4">
                            ...
                            <p className="text-sm text-on-surface-variant leading-relaxed font-sans">
                              ...
                              of your prize matrix will be automatically
                              allocated to {selectedCharity.name} upon win
                              confirmation.
                            </p>
                          </div>
                        </div>
                        ...
                        >
                          {saving ? (
                            ...
                            <Save className="w-5 h-5 invisible" />
                          )}
                          Archive Preferences
                        </button>
                      </div>
                      ...
                      <div className="py-20 flex flex-col items-center text-center">
                        ...
                        <p className="text-sm text-on-surface-variant font-sans px-8">
                          No designated impact beneficiary located. Search the
                          partner network to initialize.
                        </p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="glass-card p-10 bg-gradient-to-br from-primary/10 to-transparent border-primary/20 group mb-8">
                    <div className="flex items-center gap-6 mb-10">
                      ...
                      <div>
                        ...
                        <p className="text-3xl font-display font-black text-primary tracking-tighter">
