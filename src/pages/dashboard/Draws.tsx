      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
        <div>
          ...
          <p className="text-on-surface-variant max-w-2xl">
            Historical outcomes of the Play Golf draws. Active subscribers enter
            once their latest 5 scores are available.
          </p>
        </div>
      </div>
        ...
        {!isPremium && (
          <div className="absolute inset-0 z-50 bg-background/60 backdrop-blur-md flex items-center justify-center rounded-[2.5rem] border border-dashed border-primary/20">
            <div className="text-center max-w-sm px-10">
              ...
              <p className="text-on-surface-variant mb-10 text-balance">
                Historical draw data and eligibility require a premium Matrix
                connection.
              </p>
              <Link
                to="/dashboard/subscription"
                className="px-10 py-5 bg-primary text-background rounded-full font-bold uppercase tracking-widest text-xs hover:scale-105 transition-all active:scale-95 shadow-[0_0_30px_rgba(78,222,163,0.3)]"
              >
                Connect to Matrix
              </Link>
            </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
                  ...
                  <div className="flex items-center gap-8">
                    <div className="text-right">
                      <p className="text-[9px] font-bold uppercase tracking-[0.2em] text-on-surface-variant mb-2">
                        Total Pool
                      </p>
            ...
            <div className="glass-card p-8 bg-surface-container-high/30">
              ...
              <ul className="space-y-4 text-sm text-on-surface-variant">
                <li className="flex gap-3">
                  ...
                  <p>Must have an active Play Golf subscription tier.</p>
                </li>
                <li className="flex gap-3">
                  <div className="w-5 h-5 rounded-full bg-primary/20 text-primary flex items-center justify-center flex-shrink-0 mt-0.5">
                    2
                  ...
                  <p>
                    Must have played and logged at least 1 valid 18-hole
                    Stableford round in the current month.
                  </p>
                </li>
                <li className="flex gap-3">
                  <div className="w-5 h-5 rounded-full bg-primary/20 text-primary flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <p>
                    Winners must upload algorithmic proof (verified scorecard or
                    app screenshot) within 48 hours to claim.
                  </p>
                </li>
              </ul>
            </div>
