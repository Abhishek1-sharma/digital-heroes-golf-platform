  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    try {
      ...
      if (message.toLowerCase().includes("email not confirmed")) {
        setError(
          "Please confirm your email using the Supabase verification link before logging in. For local testing, disable Confirm email under Supabase Authentication > Providers > Email.",
        );
      } else {
        ...
        <div className="glass-card p-12 relative overflow-hidden group">
          ...
          >
            <div className="space-y-3">
              <label className="text-[10px] font-bold uppercase tracking-[0.3em] text-on-surface-variant ml-2">
                Entity Identity
              </label>
              ...
              {errors.email && (
                <p className="text-[10px] font-bold uppercase tracking-widest text-red-500 mt-2 ml-2">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between px-2">
                ...
                <Link
                  ...
                  className="text-[10px] font-bold uppercase tracking-[0.2em] text-primary hover:text-secondary transition-colors"
                >
                  Forgot Key?
                </Link>
              </div>
          ...
          <div className="relative my-12">
            ...
            <div className="relative flex justify-center text-[10px] uppercase tracking-[0.3em]">
              <span className="bg-surface-container px-6 text-on-surface-variant font-bold">
          ...
          <div className="grid grid-cols-2 gap-6 relative z-10">
            <button
              ...
              className="flex items-center justify-center gap-4 py-5 rounded-2xl bg-surface-container-high border border-white/5 text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-white/5 transition-all active:scale-95"
            >
