...
import { PLANS } from "../lib/platform";

const Home: React.FC = () => {
  const { user } = useAuth();
  usePageTitle("Play Golf");
    ...
    <div className="flex flex-col bg-background">
          ...
          >
            <div className="relative group w-fit">
              ...
              <div className="relative inline-flex items-center gap-4 px-6 py-2 rounded-full border border-white/10 bg-black/40 backdrop-blur-2xl w-fit shadow-[0_0_15px_rgba(78,222,163,0.1)]">
                ...
                <span className="font-sans text-[10px] font-bold uppercase tracking-[0.4em] text-secondary">
            ...
            <h1 className="font-display text-7xl md:text-[160px] leading-[0.85] font-black uppercase tracking-tighter max-w-6xl">
              Play <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-on-surface italic">
                for Good.
              </span>
            </h1>

            <p className="font-sans text-lg md:text-2xl text-on-surface-variant max-w-2xl leading-relaxed">
              Track your latest five rounds, enter the monthly draw, and direct
              part of your membership to a charity you believe in.
            </p>

            <div className="flex flex-col md:flex-row items-center gap-8 mt-4">
              <Link
                to="/signup"
                className="group relative px-12 py-6 rounded-full bg-white text-background font-bold text-lg uppercase tracking-widest overflow-hidden hover:scale-105 transition-all active:scale-95 shadow-2xl shadow-white/10"
              >
                <span className="relative z-10">Choose your cause</span>
                <div className="absolute inset-0 bg-primary translate-y-full group-hover:translate-y-0 transition-transform duration-500" />
              </Link>
              <Link
                to="/charities"
                className="text-on-surface-variant hover:text-white font-bold uppercase tracking-[0.3em] text-xs transition-colors flex items-center gap-4 group"
              >
                See the impact network
      ...
      <section className="py-24 px-6 md:px-12 border-y border-white/5">
        <div className="max-w-[1920px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
          <div className="space-y-2">
            <p className="font-display text-7xl font-black text-secondary tracking-tighter">
              £2.4M
            </p>
            <p className="font-sans text-base uppercase tracking-widest text-on-surface-variant">
              Donated to Global Causes
            </p>
          </div>
          <div className="space-y-2">
            <p className="font-display text-7xl font-black text-primary tracking-tighter">
              15k+
            </p>
            <p className="font-sans text-base uppercase tracking-widest text-on-surface-variant">
          ...
          <div className="space-y-2">
            <p className="font-display text-7xl font-black text-on-surface tracking-tighter">
              250+
            </p>
            <p className="font-sans text-base uppercase tracking-widest text-on-surface-variant">
      ...
      <section className="py-32 px-6 md:px-12 max-w-[1920px] mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
          <div className="max-w-2xl">
            <h2 className="font-display text-5xl md:text-6xl font-extrabold tracking-tight mb-6 uppercase">
              Master the Circle
            </h2>
            <p className="font-sans text-on-surface-variant text-lg">
              A seamless orchestration of skill and generosity, designed for
              those who demand excellence in every action.
            </p>
          </div>
          <span className="hidden md:block font-display text-9xl font-black text-white/5 pointer-events-none uppercase tracking-tighter">
            PROCESS
          </span>
        </div>
          ...
          {[
            {
              id: "01",
              title: "Subscribe",
              desc: "Choose your tier of impact. From Monthly to Sovereign Yearly, every membership fuels the engine of change.",
            },
            {
              id: "02",
              title: "Add Scores",
              desc: "Log your achievements. Our precise tracking system validates your prowess against the elite global field.",
              delay: 0.1,
              mt: true,
            },
            {
              id: "03",
              title: "Enter Monthly Draw",
              desc: "Your skill translates into participation. Monthly draws reward the most consistent catalysts.",
              delay: 0.2,
            },
            {
              id: "04",
              title: "Support & Win",
              desc: "Experience the dual thrill of personal victory and tangible global contribution. Elevate yourself by elevating others.",
              delay: 0.3,
              mt: true,
              highlight: true,
            },
            ...
            <motion.div
              ...
              className={cn(
                ...
                step.highlight
                  ? "bg-surface-container-high border-t-2 border-primary/20"
            ...
            >
              ...
              <h3 className="font-display text-2xl font-bold mt-12 mb-4 uppercase">
                {step.title}
              </h3>
      ...
      <section className="py-32 px-6 md:px-12 bg-surface-container-lowest relative overflow-hidden">
        ...
        <div className="max-w-[1920px] mx-auto relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <h2 className="font-display text-5xl font-extrabold uppercase">
              The Impact Matrix
            </h2>
            <Link
              to="/charities"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {loadingCharities ? (
              [1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="glass-card h-96 animate-pulse bg-white/5 rounded-[2.5rem]"
                />
              ))
              ...
              featuredCharities.map((charity, idx) => (
                ...
                >
                  <Link
                    ...
                    className="bg-background rounded-[2.4rem] overflow-hidden block h-full"
                  >
                    ...
                    <div className="p-8">
                      ...
                      <h4 className="font-display text-2xl font-bold mt-4 mb-2 uppercase">
                        {charity.name}
                      </h4>
              ...
              <div className="col-span-full py-20 text-center glass-card border-dashed">
                <p className="text-on-surface-variant uppercase tracking-widest text-sm font-bold">
                  Network nodes initializing...
                </p>
              </div>
            )}
          </div>
      ...
      <section className="py-32 px-6 md:px-12 max-w-[1920px] mx-auto">
        <div className="text-center mb-24">
          <h2 className="font-display text-5xl font-extrabold mb-6 uppercase tracking-tighter">
            The Rewards Hierarchy
          </h2>
          <p className="text-on-surface-variant max-w-xl mx-auto">
            Precision is rewarded. Every tier of excellence unlocks a new
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
          <div className="relative p-10 bg-surface-container rounded-full aspect-square flex flex-col items-center justify-center text-center border border-white/5">
            <span className="font-display text-xs font-bold text-primary mb-4 tracking-[0.3em] uppercase">
              Platinum Match
            </span>
            <h5 className="font-display text-6xl font-black mb-4">5/5</h5>
            <p className="font-sans text-on-surface-variant text-sm">
              Access to the Sovereign Vault.
              <br />
              £1M+ Prize Pool Entry.
            </p>
          </div>
          ...
          <div className="relative p-10 bg-surface-container-high rounded-full aspect-square flex flex-col items-center justify-center text-center border-2 border-primary/20 md:scale-110 shadow-[0_0_80px_rgba(78,222,163,0.1)]">
            <span className="font-display text-xs font-bold text-secondary mb-4 tracking-[0.3em] uppercase">
              Gold Match
            </span>
            <h5 className="font-display text-6xl font-black mb-4">4/5</h5>
            <p className="font-sans text-on-surface-variant text-sm">
              Tiered monthly rewards.
              <br />
              Built from the active prize pool.
            </p>
            <div className="absolute -top-4 bg-primary text-background px-6 py-1 rounded-full text-xs font-bold uppercase tracking-widest">
              MOST FREQUENT
            </div>
          </div>

          <div className="relative p-10 bg-surface-container rounded-full aspect-square flex flex-col items-center justify-center text-center border border-white/5">
            <span className="font-display text-xs font-bold text-tertiary mb-4 tracking-[0.3em] uppercase">
              Silver Match
            </span>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="p-12 bg-surface-container rounded-[3rem] border border-white/5">
              <h3 className="font-display text-3xl font-bold mb-2 uppercase">
                Elite Monthly
              </h3>
              <p className="text-on-surface-variant mb-8">
                Maintain your edge month-by-month.
              </p>
              <div className="flex items-baseline gap-2 mb-8">
                <span className="text-5xl font-black">£25</span>
                <span className="text-on-surface-variant font-sans text-sm uppercase tracking-widest">
                  / Month
                </span>
              </div>
              ...
              <Link
                ...
                className="block w-full py-5 rounded-full border border-primary text-primary text-center font-bold hover:bg-primary/5 transition-all"
              >
            ...
            <div className="relative p-12 bg-gradient-to-br from-surface-container-highest to-background rounded-[3rem] border-2 border-secondary/30 overflow-hidden shadow-2xl shadow-secondary/10">
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="bg-secondary text-background px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest">
                    Best Value
                  </span>
                </div>
                <p className="text-on-surface-variant mb-8">
                  A legacy commitment to excellence.
                </p>
                <div className="flex items-baseline gap-2 mb-8">
                ...
                <Link
                  to={user ? "/dashboard" : "/signup"}
                  className="block w-full py-5 rounded-full bg-gradient-to-r from-secondary to-secondary-container text-background text-center font-bold hover:scale-105 transition-all"
                >
      ...
      <section className="py-48 px-6 md:px-12 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <Link
            to={user ? "/dashboard" : "/signup"}
            className="inline-block px-16 py-6 rounded-full bg-gradient-to-br from-primary to-primary-container text-background font-bold text-xl hover:scale-105 transition-all active:scale-95 shadow-xl shadow-primary/20"
          >
